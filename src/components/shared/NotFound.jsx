    ...
    return ( 
        <div className="h-screen sm:flex items-center justify-around p-8 bg-red-500 text-white">
            <div className="sm:text-left text-center">
                <h3 className="text-xl font-bold mb-4">Oops! You lost in the vegan world.</h3>
                <p className="text-sm">The page you're looking is now beyond our reach.</p>
                <p className="text-sm sm:mb-8 mb-4">Let's get you on track...</p>
                <Link to="/" className="bg-green-500 text-white text-sm rounded font-bold p-2">HOME PAGE</Link>
            </div>
