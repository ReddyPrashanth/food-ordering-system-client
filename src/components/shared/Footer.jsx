        ...
        <div className="lg:px-16 px-6 bg-white py-2 flex divide-x">
            <div className="lg:w-1/3 md:w-1/4 mr-1">
                <div className="flex-1 flex justify-between items-center">
                    <a className="flex items-center" href="/">
                        ...
                        <span className="text-green-500 uppercase font-semibold md:text-lg text-xs">Restaurant App</span>
                    </a>
                </div>
            </div>
            <div className="lg:w-1/3 md:w-1/4">
                <div className="ml-1">
                    <h4 className="sm:text-sm text-xs font-medium text-center">FOLLOW US ON</h4>
            ...
            <div className="lg:w-1/3 md:w-1/2">
                <div className="ml-1 text-center">
                    <p className="sm:text-sm text-xs font-medium">NEWS LETTER</p>
                    <div>
